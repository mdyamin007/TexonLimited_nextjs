  ...
  return (
    <section className="relative my-24">
      ...
      <div className="relative flex z-10 flex-col justify-center items-center mb-12">
        ...
        <h1 className="text-gray-700 font-extrabold text-4xl md:text-5xl">
          Professional technology services
        </h1>
        <h1 className="text-gray-700 font-extrabold text-4xl md:text-5xl mb-4">
          with fair pricing plan
        </h1>
      ...
      <div className="container mx-auto px-5 py-24">
        <div className="flex flex-wrap -m-4">
          ...
          <div className="p-4 lg:w-1/3 md:w-1/2 w-full">
            <div className="h-full p-6 rounded-lg border-2 border-blue-600 flex flex-col relative overflow-hidden">
              ...
              <button className="flex items-center mt-auto text-white bg-blue-600 border-0 py-2 px-4 w-full focus:outline-none hover:bg-blue-700 rounded">
                Start now
                <svg
                  fill="none"
                  stroke="currentColor"
      ...
      <div className="flex justify-center">
        <div className="flex-shrink bg-gray-200 px-4 py-2 text-lg font-semibold text-gray-500 rounded-lg">
          <p>
            You can learn more about pricing plans from
            <span className="text-blue-600"> pricing page</span>
          </p>
        </div>
      </div>
    </section>
