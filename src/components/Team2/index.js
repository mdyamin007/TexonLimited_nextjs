    ...
    <section className="text-gray-600 body-font mt-20">
      <div className="relative bg-gray-800 text-white">
        ...
        <div className="container mx-auto px-10">
          <div className="justify-between flex lg:flex-row flex-col mb-32">
            <div className="text-white w-full lg:w-2/3 mt-4">
              <h1 className="text-4xl md:text-6xl font-medium mb-6">
                Our professional team working for
                <span className="font-bold"> your business</span>
              </h1>
              <div className="">
                <p>Lepatuda accumsan id nisi in ullamcorper. Nullam leo diam</p>
                <p>maximus vitae interdum non, pharetra sit amet est.</p>
              </div>
            </div>
            <div className="my-4 flex items-center">
              <div className="inline-flex items-center justify-center px-4 py-3 bg-gray-600 hover:bg-blue-600 cursor-pointer">
                Meet our team
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5"
