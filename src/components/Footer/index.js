...
const Footer = () => {
  return (
    <footer class="text-white body-font bg-black">
      <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          <a class="flex title-font font-medium items-center md:justify-start justify-center text-white">
            ...
            <span class="ml-3 text-2xl font-semibold">Texon Ltd.</span>
          </a>
          <p class="my-5 text-sm text-white">
            Duis at porttitor urna, eu cursus tortor. Vestibulum magna metus,
            tempor id arcu ac, convallis mattis risus. Nam efficitur, purus vel
            pharetra lacinia
          </p>
      ...
      <hr className="mx-14" />
      <div>
        <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col justify-between sm:flex-row">
